...
const ICONS = {
  ...
  line: `
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M20.2 11.2c0 4-3.7 7.2-8.2 7.2-.8 0-1.6-.1-2.3-.3L5 20.5l1.1-4C4.7 15.2 3.8 13.3 3.8 11.2 3.8 7.2 7.5 4 12 4s8.2 3.2 8.2 7.2Z"></path>
      <path d="M8.3 9.3v4.1M10.5 9.3v4.1M10.5 9.3l2.4 4.1V9.3M15.1 9.3h2.7M15.1 11.3h2.3M15.1 13.4h2.7"></path>
    </svg>`,
  mail: `
    <svg viewBox="0 0 24 24" aria-hidden="true">
